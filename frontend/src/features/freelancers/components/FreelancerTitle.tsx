          ...
          <div className="flex gap-2">
            <button
              ...
              className={clsx(
                ...
                "bg-primary-100/10 text-neutral-80 transition-colors",
                "hover:cursor-pointer hover:bg-primary-100/20",
              )}
              title="Cancelar"
            >
              <MdCancel size={20} />
            ...
            <button
              ...
              className={clsx(
                "flex h-8 w-8 shrink-0 items-center justify-center rounded-full ",
                "bg-secondary-100/30 text-neutral-80 transition-colors",
        ...
        <>
          ...
          {isEditable && (
            <button
              ...
              className={clsx(
                "flex h-8 w-8 shrink-0 items-center justify-center rounded-full",
                "text-neutral-80 transition-colors hover:bg-primary-100/20",
