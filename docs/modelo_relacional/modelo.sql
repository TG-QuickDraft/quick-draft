...
CREATE TABLE IF NOT EXISTS "avaliacoes_cliente" (
	"avc_id" INTEGER NOT NULL UNIQUE GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS "avaliacoes_freelancer" (
	"avf_id" INTEGER NOT NULL UNIQUE GENERATED BY DEFAULT AS IDENTITY,
	"avf_cli_id" INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS "denuncias" (
	"den_id" INTEGER NOT NULL UNIQUE GENERATED BY DEFAULT AS IDENTITY,
